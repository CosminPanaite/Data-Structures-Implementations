...
void testAll() { 
	...
	SortedSet s3(r2);
	assert(s3.add(5) == true);
	assert(s3.add(1) == true);
	assert(s1.isSubsetOf(s3) == false);
	SortedSet s4(r2);
	SortedSet s5(r2);								///tests for extra operation
	assert(s1.isSubsetOf(s4) == false);
	assert(s4.isSubsetOf(s1) == true);
	assert(s4.isSubsetOf(s5) == true);
	SortedSet s6(r2);
	assert(s6.add(7) == true);
	assert(s6.add(8) == true);
	assert(s6.add(9) == true);
	assert(s6.isSubsetOf(s2)==true);
